...
-`加密 <密钥> <明文>`: 使用用户输入的6位密钥对文本进行加密，得到`我`、`要`、`吃`、`饭`四个字组成的密文。<br><br>
-`解密 <密钥> <密文>`: 使用用户输入的6位密钥对文本进行解密，得到对应的明文。<br><br>
-`Base编码 <文本>`: 对文本进行Base64编码。<br><br>
-`Base解码 <文本>`: 对文本进行Base64解码。<br><br>
...
# 其他注意事项
-1、我要吃饭加解密的密钥必须使用由**数字、字母或其混合组成**的**6位**密钥。<br><br>v
-2、指令与操作的文本之间请用空格隔开，否则无法识别。<br><br>
-3、**插件功能仅做日常娱乐和交流分享，请勿用此插件的加密功能传播你所在的国家或地区规定的非法内容，违规使用导致所有后果均由使用者承担，开发者不对此负责。** <br><br>
